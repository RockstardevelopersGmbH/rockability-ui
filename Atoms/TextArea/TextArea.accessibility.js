...
export default function checkTextAreaAccessibility(component, showLabel, autocomplete) {
    checkInputSize(component, 'textarea');
...
export function checkColorContrastInput(component) {
    return checkInputColorContrast(component, '--input-color', '--bg-color', '--input-bg', '--input-border-color', '--outline-color', '--input-error-highlight', 'textarea', true);
}
